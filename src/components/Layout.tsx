...
import { IconArrowBackUp, IconFileText, IconLayoutDashboard, IconMenu2, IconSettings, IconTags } from '@tabler/icons-react';
...
const navigation = [
  ...
  { name: 'Täglicher Check-in', href: '/taeglicher-check-in', icon: IconTags },
  { name: 'Tracking-Einträge', href: '/tracking-eintraege', icon: IconFileText },
  { name: 'Gewohnheiten', href: '/gewohnheiten', icon: IconFileText },
];

const externalNavigation = [
  { name: 'Täglicher Check-in', href: '/gateway/apps/699d82aeceb3f171fccf9d4c?template=list_page', icon: IconTags },
  { name: 'Tracking-Einträge', href: '/gateway/apps/699d82adf12ba85b5d3e8b45?template=list_page', icon: IconFileText },
  { name: 'Gewohnheiten', href: '/gateway/apps/699d82a9f2a4cf5dbf7a58d8?template=list_page', icon: IconFileText },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <nav className="px-3 pt-4 space-y-0.5">
          <a
            href="/gateway/apps/699d82aeceb3f171fccf9d4c?template=list_page"
